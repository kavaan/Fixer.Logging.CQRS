...
using Fixer.Logging.CQRS.Decorators;
...
namespace Fixer.Logging.CQRS
{
    ...
    {
        public static IFixerBuilder AddCommandHandlersLogging(this IFixerBuilder builder, Assembly assembly = null)
            => builder.AddHandlerLogging(typeof(ICommandHandler<>), typeof(CommandHandlerLoggingDecorator<>), assembly);

        public static IFixerBuilder AddEventHandlersLogging(this IFixerBuilder builder, Assembly assembly = null)
